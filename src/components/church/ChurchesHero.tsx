...
export const ChurchesHero: React.FC<ChurchesHeroProps> = ({
  title = 'OUR CHURCHES',
  goldSubtitle = 'CHURCH LOCATIONS & DIRECTORY',
  ...
  return (
    <section className="relative bg-navy text-white overflow-hidden py-16 sm:py-24 border-b border-navy-light">
      ...
      <div className="absolute inset-0 z-0 opacity-25">
        <img
          src={bgImage}
          alt="Church of God Subic Worship Community"
      ...
      <Container size="wide" className="relative z-10">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <nav aria-label="Breadcrumb" className="inline-flex items-center justify-center space-x-2 text-xs font-bold uppercase tracking-wider text-slate-300">
            ...
            <span className="text-gold">Our Churches</span>
          </nav>
          ...
          <div className="pt-1 flex justify-center">
            <ContentVerificationBadge
              ...
              notes="Church campus directory records & schedules are undergoing official administrative verification."
            />
          </div>

          {/* Header Typography */}
          <div className="space-y-3">
            <span className="text-xs sm:text-sm font-black tracking-widest text-gold uppercase block">
              {goldSubtitle}
            </span>
          ...
          <div className="pt-4 max-w-2xl mx-auto">
            <div className="p-3.5 bg-navy-light/80 rounded-xl border border-gold/20 text-xs text-slate-300 flex items-start space-x-3 text-left">
              ...
              <p className="leading-relaxed">
                <strong className="text-gold font-bold">Content Governance Notice:</strong> The church locations listed below represent candidate campus directories. Specific addresses, pastoral leadership, and weekly gathering schedules will be finalized upon official leadership confirmation.
              </p>
            </div>
          </div>
